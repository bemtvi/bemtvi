...
pub use editor::{
    ...
    FileChangeAction, FileChangeReason, FloatAnchor, FloatConfig, FloatRelative, GlobalMarkEntry,
    PendingOpen, PendingQuitAll, PendingSave, PersistState, RegisterEntry, TabId, UndoEntry,
