#!/usr/bin/env bash
# Netlify build entry for the **standard** nxvim wasm edit-host (crates/nxvim-edithost) — the
# real in-browser editor: nxvim-core + the PUC Lua 5.4 VM + the full server tick compiled to
