// bemtvi-regex shim for nvim/option_vars.h: the option globals the engine
// reads, instantiated in shim/btvre_shim.c with vim's defaults and settable
// through the btvre_* API.
#pragma once
