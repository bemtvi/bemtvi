...
# The `btv.http.mount` Service Worker, at the publish ROOT rather than beside the page in
...
cp "$here/web/btv-sw.js" "$site/btv-sw.js"
...
# bemtvi edit-host — static site

The bemtvi editor compiled to WebAssembly: a fully client-side editor, no server-side
