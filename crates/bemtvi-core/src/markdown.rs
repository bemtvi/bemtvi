//! A pure CommonMark + GFM → *stripped-lines + styling* renderer for bemtvi's
...
//! and bemtvi used to drop it into a float verbatim — so you saw the literal
...
//! Lua surface (`btv.markdown.render`) exposes the same output to plugins.
//!
...
/// stands out of the rule it is inset in: `Special`, the group bemtvi already accents
