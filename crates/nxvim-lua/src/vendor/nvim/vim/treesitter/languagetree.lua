-- Vendored verbatim from neovim: runtime/lua/vim/treesitter/languagetree.lua (commit 70cfeab).
-- Copyright Neovim contributors. Licensed under the Apache License, Version 2.0;
-- see crates/nxvim-lua/src/vendor/nvim/LICENSE. The only change is this header.
-- nxvim runs this upstream Lua on its own treesitter primitives — see
