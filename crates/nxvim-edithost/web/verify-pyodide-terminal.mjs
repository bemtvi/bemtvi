...
// verify serves demo-site/ via NXVIM_SERVE_ROOT.
//
...
try {
  ...
  await page.evaluate(() => window.__nxvim.feed(":w /demo.py<CR>"));
  ...
  await page.evaluate(() => window.__nxvim.feed(":terminal python /demo.py<CR>"));
