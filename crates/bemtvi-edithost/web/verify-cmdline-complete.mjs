// Verifier for command-line completion (`:`+<Tab> — btv.cmdline_complete) auto-enabling
...
// any user config calling `btv.cmdline_complete.setup{}`.
//
...
try {
  ...
  await page.evaluate(() => window.__bemtvi.feed(":e"));
  await sleep(80);
  await page.evaluate(() => window.__bemtvi.feed("<Tab>"));
  await sleep(150);
