...
//! [`RemoteHostFs`](bemtvi_server::RemoteHostFs) talking to a
...
//! disk:
//!
//! - `bemtvi /virtual/proj` (startup) lists the remote directory's entries.
...
use bemtvi_test_harness::{await_lines, feed, spawn_with_daemon_fs, DaemonFs};
