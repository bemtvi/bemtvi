// nxvim-regex shim for nvim/buffer_defs.h.
//
...
typedef const char *(*nxre_get_line_fn)(void *userdata, linenr_T lnum, colnr_T *len);

struct file_buffer {
  nxre_memline_T b_ml;       ///< line count lives here (upstream layout)
  ...
  nxre_get_line_fn nx_get_line;  ///< nxvim line provider
  void *nx_ud;                   ///< passed to nx_get_line
};
