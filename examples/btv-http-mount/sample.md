...
This document is served by the editor itself, over `btv.http.mount`.
...
btv.http.mount({
  ...
  btv.ui.open(m:url())     -- http://127.0.0.1:53124/plugin/preview/
end)
```
...
1. `btv.o.httpport = 8080` pins a stable, bookmarkable port.
