...
pub use editor::{
    ...
    PendingOpen, PendingQuitAll, PendingSave, PersistState, PreviewTarget, PromptPos,
    RegisterEntry, ShadaRequest, TabId, TerminalOp, UndoEntry, UndoTreeView, WindowConfigSpec,
    WindowId,
};
