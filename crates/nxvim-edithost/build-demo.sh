...
#
# Run:  ./build-demo.sh   then   NXVIM_SERVE_ROOT=demo-site node web/serve.mjs
set -euo pipefail
cd "$(dirname "$0")"
...
echo "serve it:  NXVIM_SERVE_ROOT=demo-site node web/serve.mjs   then open http://localhost:8088/web/"
