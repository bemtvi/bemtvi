-- ~~~ bemtvi btv.snippet playground: the native snippet engine ~~~
--
-- Run it (from the repo root) against the sample buffer:
--
--     BEMTVI_CONFIG=examples/snippets \
--       cargo run -p bemtvi -- examples/snippets/sample.lua
--
-- `btv.snippet` is the native snippet engine (docs/plans/2026-06-15-btv-snippet-engine.md,
...
btv.keymap.set("i", "<C-s>", function()
  btv.snippet.expand("print(${1:value})$0")
