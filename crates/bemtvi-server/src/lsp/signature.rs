...
//! indent (see [`Editor::open_signature_float`](bemtvi_core::Editor::open_signature_float)),
...
use bemtvi_core::{SIGNATURE_MARKER_COL, SIGNATURE_PARAM_INDENT};
use bemtvi_lsp::SignatureInfo;
...
/// are painted by [`Editor::open_signature_float`](bemtvi_core::Editor::open_signature_float),
...
pub(crate) fn with_server_name(layout: SignatureLayout, name: &str) -> SignatureLayout {
    ...
    lines.push(bemtvi_core::markdown::section_header_line(name));
