...
pub use editor::{
    ...
    CommandPending, CommandStatus, CompleteConfig, CompleteKeys, Cursor, DecorViewport,
    DeferredCmd, Editor, Extent, FileChangeAction, FileChangeReason, FileChangelist, FileFolds,
