...
//! to the LSP foldexpr marker (`btv.lsp.foldexpr`) and its server advertises
...
impl EditHost {
    ...
    pub(crate) fn request_folding_range(&mut self, buffer: BufferId) {
        ...
        self.fx
            .lsp_request(key, token, bemtvi_lsp::LspRequest::FoldingRange { uri });
    }
