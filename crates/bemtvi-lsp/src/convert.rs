...
/// Reduce a `textDocument/foldingRange` reply to bemtvi's whole-line spans: each
...
/// bookkeeping, and bemtvi applies against the buffer it has.
#[derive(Debug, serde::Deserialize)]
...
/// downstream doc-float / docs-sidebar renders them through `bemtvi_core::markdown`
